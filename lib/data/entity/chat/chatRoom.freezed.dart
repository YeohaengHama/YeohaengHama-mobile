...
abstract class $ChatRoomCopyWith<$Res> {
  ...
  @useResult
  $Res call({String roomId, String name, List<String> users});
}
...
class _$ChatRoomImpl implements _ChatRoom {
  ...
  @override
  String toString() {
    return 'ChatRoom(roomId: $roomId, name: $name, users: $users)';
  }
...
abstract class _ChatRoom implements ChatRoom {
  factory _ChatRoom(
      ...
      required final List<String> users}) = _$ChatRoomImpl;
