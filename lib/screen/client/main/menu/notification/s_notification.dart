    ...
    return Scaffold(
      ...
      body: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          ClipOval(child: Container( width: 35, height :35,color: AppColors.mainPurple, child: Icon(Icons.notifications_none,color: Colors.white,))),
                          Width(10),
                          '일정에 초대되었습니다.'.text.size(15).make(),
                        ],
