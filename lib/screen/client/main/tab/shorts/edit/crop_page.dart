            ...
            Row(children: [
              Expanded(
                child: IconButton(
                  ...
                  icon: const Icon(Icons.rotate_left,color: AppColors.mainPurple),
                ),
              ),
              Expanded(
                child: IconButton(
                  ...
                  icon: const Icon(Icons.rotate_right, color: AppColors.mainPurple,),
                ),
              )
            ]),
              ...
              Expanded(
                ...
                child: IconButton(
                  ...
                  icon: const Center(
                    child: Text(
                      "cancel",
                      style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.mainPurple),
                    ),
                  ),
                ),
              ),
