...
import 'package:fast_app_base/screen/client/main/tab/shorts/itinerary/w_Itinerary_map.dart';
import 'package:fast_app_base/screen/client/main/tab/shorts/itinerary/w_itinerary_place_list.dart';
import 'package:flutter/material.dart';

import '../../../../../../data/entity/itinerary/a_check_itinerary.dart';


class ItineraryPlaceHolderList extends StatelessWidget {
  final Map<String, List<PlaceByDay>?> places;

  const ItineraryPlaceHolderList({Key? key, required this.places})
      : super(key: key);
      ...
      children: places.entries.map((entry) {
        ...
        return Column(
          ...
          children: [
            ...
            SizedBox(
              height: 250,
              child: ItineraryMapWidget(placeList),
            ),
            ListView.builder(
              shrinkWrap: true,
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ItineraryPlaceListWidget(place).pOnly(right: 30),
                    ),
