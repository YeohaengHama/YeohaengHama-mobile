...
class VideoEditingScreen extends StatefulWidget {
  ...
  const VideoEditingScreen({Key? key, required this.videoFile}) : super(key: key);
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Padding(
                                            ...
                                            child: Icon(Icons.content_cut, color: AppColors.mainPurple,)),
                                        Text('컷 편집', style: TextStyle(color: AppColors.mainPurple),)
                                      ],
                                    ),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Padding(
                                            padding: EdgeInsets.all(5),
                                            child: Icon(Icons.video_label, color: AppColors.mainPurple,)),
                                        Text('커버', style: TextStyle(color: AppColors.mainPurple))
                                      ],
                                    ),
                                  ],
                                ),
          ...
          children: [
            Expanded(
              child: IconButton(
                ...
                icon: const Icon(Icons.exit_to_app, color: AppColors.whiteGrey),
            ...
            Expanded(
              child: IconButton(
                ...
                icon: const Icon(Icons.rotate_left, color: AppColors.whiteGrey),
            ...
            Expanded(
              child: IconButton(
                ...
                icon: const Icon(Icons.rotate_right, color: AppColors.whiteGrey),
            ...
            Expanded(
              child: IconButton(
                ...
                icon: const Icon(Icons.crop, color: AppColors.whiteGrey),
            ...
            Expanded(
              child: PopupMenuButton(
                ...
                icon: const Icon(Icons.save, color: AppColors.whiteGrey,),
