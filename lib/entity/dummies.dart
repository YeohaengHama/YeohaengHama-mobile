...
final review1 = Review(tourism: tourism1, id: 1, user: user1,score: 5.0, wirteTime:DateTime.now(), contents: '봄기운이 도는 완주, 익산여행, 오랜 절친들이랑 가볍게 떠나 힐링한 전완주 익산여행. 전주는 자주 갔지만 완주는 처음, 익산은 두번째 방문이었다. 기대와 설레임에 부응하는 전라북도의 기운과 선한 지역분들과의 접촉에 아직도 여행의 여운이 남아있다.');
